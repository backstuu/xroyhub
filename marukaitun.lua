...
_G.WebHook = {
    ["Enabled"] = true, -- เปิดการใช้งาน
    ["Url"] = "https://discord.com/api/webhooks/1110606287076597821/3YfNQpFrFbzMUNC2D9fXUZX-dlpgCf8DoNrm606V4ei2zYxdi8bhDKlH8AROpoPtKgqg", -- ลิ้งค์เว็บฮุก
    ["Delay"] = 60 -- วินาที
}
_G.MainSettings = {
...
getgenv().Key = "MARU-G3JB1-KZRQA-YVQO-DO5RE-3JW0"
getgenv().id = "1108370971850707075"
